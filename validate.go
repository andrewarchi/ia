...
func Validate(dir string) error {
	...
	files, err := ReadFileMeta(filepath.Join(dir, id+"_files.xml"))
	if err != nil {
		return err
	}
...
func (rv *ReadValidator) Validate() error {
	...
	if err := rv.validate("SHA-1", rv.sha1Hash, rv.sha1Sum); err != nil {
		return err
	}
	return rv.validate("CRC-32", rv.crc32Hash, rv.crc32Sum)
}
